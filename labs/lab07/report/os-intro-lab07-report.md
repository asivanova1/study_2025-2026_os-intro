...
subtitle: "по курсу: Архитектура компьютера и операционных систем"
license: "CC BY"
---
...
### 2.1. Скопируем файл /usr/include/sys/io.h в домашний каталог и назовем его equipment ([рис. @fig-002]):

![Копирование файла](image/2.png){#fig-002 width=70%}

### 2.2. В домашнем каталоге создадим директорию ~/ski.plases ([рис. @fig-003]):

![Создание директории](image/3.png){#fig-003 width=70%}

### 2.3. Переместим файл equipment в каталог ~/ski.plases ([рис. @fig-004]):
...
### 2.5. Создадим в домашнем каталоге файл abc1 и скопируем его в каталог ~/ski.plases, назовем equiplist2 ([рис. @fig-006]):

![Создание файла](image/6.png){#fig-006 width=70%}

### 2.6. Создадим каталог с именем equipment в каталоге ~/ski.plases ([рис. @fig-007]):

![Создание каталога](image/7.png){#fig-007 width=70%}

### 2.7. Переместим файлы ~/ski.plases/equiplist и equiplist2 в каталог ~/ski.plases/equipment ([рис. @fig-008]):

![Перемещение файла](image/8.png){#fig-008 width=70%}

### 2.8. Создадим и переместим каталог ~/newdir в каталог ~/ski.plases и назовем его plans ([рис. @fig-009]):
...
### 4.1. Просмотрим содержимое файла /etc/password ([рис. @fig-011]):

![Просмотр содержимого](image/11.png){#fig-011 width=70%}

### 4.2. Скопируем файл ~/feathers в файл ~/file.old ([рис. @fig-012]):

![Копирование файла](image/12.png){#fig-012 width=70%}

### 4.3. Переместим файл ~/file.old в каталог ~/play ([рис. @fig-013]):

![Перемещение файла](image/13.png){#fig-013 width=70%}

### 4.4. Скопируем каталог ~/play в каталог ~/fun ([рис. @fig-014]):

![Копирование файла](image/14.png){#fig-014 width=70%}

### 4.5. Переместим каталог ~/fun в каталог ~/play и назовем его games ([рис. @fig-015]):

![Перемещение каталога](image/15.png){#fig-015 width=70%}

### 4.6. Лишим владельца файла ~/feathers права на чтение ([рис. @fig-016]):

![Лишение права на чтение](image/16.png){#fig-016 width=70%}

### 4.7. Попытаетемся просмотреть файл ~/feathers командой cat ([рис. @fig-017]):

![Попытка просмотра файла](image/17.png){#fig-017 width=70%}

### 4.8. Попытаемся скопировать файл ~/feathers ([рис. @fig-018]):

![Попытка копирования файла](image/18.png){#fig-018 width=70%}

### 4.9. Вернем владельцу файла ~/feathers право на чтение ([рис. @fig-019]):

![Возвращение прав](image/19.png){#fig-019 width=70%}

### 4.10. Лишим владельца каталога ~/play права на выполнение ([рис. @fig-020]):

![Лишение прав на выполнение](image/20.png){#fig-020 width=70%}

### 4.11. Перейдем в каталог ~/play. Что произошло ([рис. @fig-021]):

![Переход в каталог](image/21.png){#fig-021 width=70%}

### 4.12. Вернем владельцу каталога ~/play право на выполнение ([рис. @fig-022]):
